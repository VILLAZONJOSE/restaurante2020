...
/*paginacion con ajax*/
$cantidadCategoria=$objCategoria->contarcategoria();
$paginarCategoria=7;//se va paginar de 5 en 5
$paginas=$cantidadCategoria/$paginarCategoria ;//se divide 
$paginas=ceil($paginas);//se redondea el resiltado de la division
$contador=$_SESSION["numerodepagina"];//obtien el numero de pagina 
$iniciar=($contador-1)*$paginarCategoria;
$contadorpagina=$_SESSION["numerodepagina"];
$resultado=$objCategoria->mostrarbuscar($criteriobusqueda,$valor);//se ejecuta la consulta
        ...
        <table class="table table-bordered table-striped table-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    ?>
                    <td>
                            <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modalModificarCategoria" onclick="cargarDatosModalModificar('<?php echo $datos?>');">
                            <i class="icon-pencil"></i>
                            </button>
                            <!-- boton de elimiar -->
                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modalDesactivarActivarEliminarCategoria" onclick="cargarDatoModalActivarEliminar(`<?php echo $datos?>`,`eliminar`)">
                            ...
                            ?>
                            <!-- boton de desactivar -->
                            <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modalDesactivarActivarEliminarCategoria" onclick="cargarDatoModalActivarEliminar(`<?php echo $datos?>`,`desactivar`);" >
                            ...
                            <?php
                                ...
                                ?>
                                <!-- boton de activar -->
                            <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modalDesactivarActivarEliminarCategoria" onclick="cargarDatoModalActivarEliminar(`<?php echo $datos?>`,`activar`);" >
...
{
    $sql2="select*from categoria limit $iniciar,$paginarCategoria";
